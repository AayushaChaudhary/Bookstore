        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="my-2 d-flex align-items-center justify-content-center">
                    <a href="{{ route('profile.orders') }}" class="btn btn-success me-2 d-flex align-items-center">
                    ...
                    <a href="{{ route('profile.edit') }}" class="btn btn-primary me-2 d-flex align-items-center">
                        <svg class="me-2" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <a href="{{ route('profile.password') }}" class="btn btn-info d-flex align-items-center">
                        <svg class="me-2" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
