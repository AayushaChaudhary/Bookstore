...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input type="file" name="sample_pdf" class="form-control-file @error('sample_pdf') is-invalid @enderror">
            @error('sample_pdf')
            <small class ="form-text text-danger">
            {{ $message }}</small>
            @enderror
        ...
        <div class="form-group">
            ...
            <input type="number" name="initial_stock" id="initial_stock" class="form-control @error('initial_stock')is-invalid @enderror"
